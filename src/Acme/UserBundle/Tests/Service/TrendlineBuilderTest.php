 ...
 * Time: 15:57
 */
namespace Acme\UserBundle\Tests\Service;

use Acme\UserBundle\Entity\PortfolioItem;
use Acme\UserBundle\Entity\Symbol;
use Acme\UserBundle\Service\TrendlineBuilder;
...
class TrendlineBuilderTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testBuild() {
        ...
        $dataProvider = $this->getMockBuilder('Acme\YahooBundle\DataProvider\Finance\History')
