...
use AppBundle\Form\PortfolioItemType;
...
class PortfolioItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:PortfolioItem')->findByUser($this->getUser());
     ...
     * @Method("POST")
     * @Template("AppBundle:PortfolioItem:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:PortfolioItem')->find($id);
     ...
     * @Method("GET")
     * @Template("AppBundle:PortfolioItem:edit.html.twig")
     */
